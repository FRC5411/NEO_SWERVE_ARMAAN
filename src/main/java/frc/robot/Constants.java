...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final int kFrontLeftAngleCanCoderId = 31;
    public static final int kRearLeftAngleCanCoderId = 33;
    public static final int kFrontRightAngleCanCoderId = 32;
    public static final int kRearRightAngleCanCoderId = 34;
